...
static const char* varjo_GazeParametersValue_OutputFrequency100Hz = "OutputFrequency100Hz";  //!< 100Hz output frequency.
static const char* varjo_GazeParametersValue_OutputFrequency200Hz = "OutputFrequency200Hz";  //!< 200Hz output frequency.
static const char* varjo_GazeParametersValue_OutputFrequencyMaximumSupported =
    "OutputFrequencyMaximumSupported";  //!< Maximum output frequency supported by connected HMD. This is the default mode. Currently it is 200Hz for all
                                        //!< supported Varjo devices.
